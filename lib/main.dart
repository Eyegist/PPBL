...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<int> addSahams() async {
    Saham tlkm = Saham(
        ticker: "TLKM", open: 3380, high: 3500, last: 3490, change: "2,05");
    Saham ammn = Saham(
        ticker: "AMMN", open: 6750, high: 6750, last: 6500, change: "-3,7");
    Saham bren = Saham(
        ticker: "BREN", open: 4500, high: 4610, last: 4580, change: "1,78");
    Saham cuan = Saham(
        ticker: "CUAN", open: 5200, high: 5525, last: 5400, change: "3,85");
        ...
        children: [
          ...
          Expanded(
            child: FutureBuilder<List<Saham>>(
              ...
              builder:
                  (BuildContext context, AsyncSnapshot<List<Saham>> snapshot) {
                if (snapshot.hasData) {
                  return ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return ListTile(
                        ...
                        subtitle: Text(
                            'Open: ${saham.open}, High: ${saham.high}, Last: ${saham.last}'),
                        trailing: Text(
                          'Change: ${saham.change}',
                          style: TextStyle(
                            color: saham.change?.startsWith('-') ?? false
                                ? Colors.red
                                : Colors.green,
                          ),
                        ),
